--[[
	...
	Revision: $Id: BeanCounterSearch.lua 6811 2022-10-27 00:00:09Z none $
...
LibStub("LibRevision"):Set("$URL: BeanCounter/BeanCounterSearch.lua $","$Rev: 6811 $","5.1.DEV.", 'auctioneer', 'libs')
