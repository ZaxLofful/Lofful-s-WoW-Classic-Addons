isboxer.Character.Name = "DxNothing VFX1";
isboxer.Character.ActualName = "DxNothing VFX1";
isboxer.Character.QualifiedName = "DxNothing VFX1";
...
function isboxer.Character_LoadBinds()
	if (isboxer.CharacterSet.Name=="Loffulz") then
		...
		isboxer.SetMacro("InviteTeam","ALT-CTRL-SHIFT-I","/invite Erwyn-Grobbulus\n/invite Hoeboykiu-Grobbulus\n",nil,nil,nil,1);
...
isboxer.Output("Character 'DxNothing VFX1' activated");
