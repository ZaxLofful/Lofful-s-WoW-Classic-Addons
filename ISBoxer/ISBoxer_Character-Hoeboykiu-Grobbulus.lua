isboxer.Character.Name = "Hoeboykiu-Grobbulus";
isboxer.Character.ActualName = "Hoeboykiu";
isboxer.Character.QualifiedName = "Hoeboykiu-Grobbulus";
...
function isboxer.Character_LoadBinds()
	if (isboxer.CharacterSet.Name=="Loffulz") then
		...
		isboxer.SetMacro("InviteTeam","ALT-CTRL-SHIFT-I","/invite Erwyn\n/invite DxNothing VFX1\n",nil,nil,nil,1);
...
isboxer.Output("Character 'Hoeboykiu-Grobbulus' activated");
